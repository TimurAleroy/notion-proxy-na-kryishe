...
app.post('/api/booking', async (req, res) => {
  ...
  try {
    ...
    bookingsMap.set(bookingId, { phone, entry: bookingEntry, telegramId: telegramId || null, telegramUsername: telegramUsername || null, name });
    ...
    if (update.callback_query) {
      ...
      if (!record) {
        ...
        await tgApi('editMessageText', {
          ...
          reply_markup: {
            inline_keyboard: [[{ text: '❌ Отменить', callback_data: `cancel:${bookingId}` }]]
          }
        });
