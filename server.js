...
const NOTION_REVIEWS_DB_ID = '994a20a76308436683487de6593747f'; // Отзывы CSI
...
// Оценки 1-3 из 10 по любой категории — считаем критичной проблемой и заводим её
// автоматически, чтобы админ увидел и разобрался, а не просто цифра утонула в статистике.
const REVIEW_CATEGORY_MAP = { kalyan: 'Кальян', napitki: 'Напитки', eda: 'Еда', komanda: 'Команда' };
...
app.post('/api/review', async (req, res) => {
  ...
  try {
    ...
    // Низкие оценки по конкретным категориям — заводим отдельные "Проблемы"
